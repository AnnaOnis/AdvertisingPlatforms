        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdvertisingPlatforms_Advertisements_AdvertisementId",
                        column: x => x.AdvertisementId,
                        principalTable: "Advertisements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdvertisingPlatforms_Locations_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisingPlatforms_AdvertisementId",
                table: "AdvertisingPlatforms",
                column: "AdvertisementId");

            migrationBuilder.CreateIndex(
                name: "IX_AdvertisingPlatforms_LocationId",
                table: "AdvertisingPlatforms",
                column: "LocationId");
